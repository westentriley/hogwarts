...
import edu.tcu.cs.hogwartsartifactonline.doa.ArtifactDAO;
...
class ArtifactControllerTest {
    ...
    void findAll() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/artifacts").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.data[1].id").value(("1250808601744904193"))).andExpect(jsonPath("$.data[1].name").value("Invisibility Cloak"));
    }
